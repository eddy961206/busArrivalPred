...
config = {
    "train_csv": '../../../dataset/train/travel/travel_time_7,8_TUE_filtered_70_sl_train.csv',
    "val_csv": '../../../dataset/train/travel/travel_time_7,8_TUE_filtered_70_sl_val.csv',
    "test_csv": '../../../dataset/train/travel/travel_time_7,8_TUE_filtered_70_sl_test.csv',
    # "train_csv": '../../../dataset/train/travel/소통시간학습_수요일_filtered_train.csv',
    # "val_csv": '../../../dataset/train/travel/소통시간학습_수요일_filtered_val.csv',
    # "test_csv": '../../../dataset/train/travel/소통시간학습_수요일_filtered_test.csv',
    "train_epochs": 30,
    "n_trial": 4,
    "trial_epochs": 5,
    "patience": 15,
...
if __name__ == "__main__":
    ...
    test_data['ERROR_RATE'] = np.round(test_data['ERROR'] / test_data['TIME_GAP']).astype(int)
