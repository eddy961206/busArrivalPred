...
config = {
    "train_csv": '../../../dataset/train/travel/mini_travel_train.csv',
    "val_csv": '../../../dataset/train/travel/mini_travel_val.csv',
    "test_csv": '../../../dataset/train/travel/mini_travel_test.csv',
