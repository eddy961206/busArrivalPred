...
#
# # 데이터프레임 로드
# df = pd.read_csv('/dataset/train/travel/travel_time_7,8_TUE_filtered_70.csv', dtype=dtype_spec)
#
...
#
# # 분할된 데이터셋 저장
# train_df.to_csv('/dataset/train/travel/travel_time_7,8_TUE_filtered_70_train.csv', index=False)
# val_df.to_csv('/dataset/train/travel/travel_time_7,8_TUE_filtered_70_val.csv', index=False)
# test_df.to_csv('/dataset/train/travel/travel_time_7,8_TUE_filtered_70_test.csv', index=False)
...
csv = '../../../dataset/train/travel/240930_노선1개_3.4~9.23_평일_속도X/train_filtered.csv'
# cuDF DataFrame으로 로드
...
train_df, temp_df = train_test_split(df_multiple.to_pandas(), test_size=0.3, stratify=df_multiple['BUSINFOUNIT_ID'].to_pandas(), random_state=42)
