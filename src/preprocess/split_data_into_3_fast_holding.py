...
df = dd.read_csv('../dataset/holding_time_7.csv', usecols=['DAY_TYPE', 'BUSROUTE_ID', 'LOCATION_ID', 'TIME_GAP', 'DEP_TIME'])
...
# 분할된 데이터셋 저장 경로 설정
train_output_path = '../dataset/holding_time_7_train.csv'
validation_output_path = '../dataset/holding_time_7_val.csv'
test_output_path = '../dataset/holding_time_7_test.csv'
